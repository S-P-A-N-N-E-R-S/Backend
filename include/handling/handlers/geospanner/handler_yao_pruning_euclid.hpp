...
/**
 * @brief Handler for the yao graph pruning heuristic. Requests need as input a graph,
 ...
 * 
 */
class yao_pruning_euclid_handler : public abstract_handler
{
public:
    yao_pruning_euclid_handler(std::unique_ptr<abstract_request> request);

    virtual ~yao_pruning_euclid_handler() = default;
